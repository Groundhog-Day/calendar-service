...
client.query('DROP TABLE IF EXISTS reservations CASCADE') // drop table to delete all previously save data
  .then(() => (
    client.query(
  ...
  .catch( (e) => {
    console.log('error in dropping or creating reservations tables');
    console.error(e);
    client.end();
  })
  .then( () => {
